#!/usr/bin/env python3
"""
Upload additional onboarding seed data to Supabase knowledge_base table
"""
...
def upload_additional_data():
    """Upload additional onboarding Q&A pairs to Supabase"""
    
    print("🚀 Starting additional data upload...")
    ...
    # Read CSV file
    csv_file = 'additional_onboarding_data.csv'
    ...
    print(f"📊 Found {len(data_to_insert)} additional Q&A pairs to upload")
